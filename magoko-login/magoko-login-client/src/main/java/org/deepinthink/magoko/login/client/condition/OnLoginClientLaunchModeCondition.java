 ...
 */
package org.deepinthink.magoko.login.client.condition;
...
class OnLoginClientLaunchModeCondition extends SpringBootCondition {
  ...
  public ConditionOutcome getMatchOutcome(
    ...
    Map<String, Object> attributes =
        Objects.requireNonNull(
            metadata.getAnnotationAttributes(ConditionalOnLoginClientLaunchMode.class.getName()));
  ...
  private ConditionOutcome getMatchOutcome(
    ...
    ConditionMessage.Builder builder =
        ConditionMessage.forCondition(ConditionalOnLoginClientLaunchMode.class);
    try {
