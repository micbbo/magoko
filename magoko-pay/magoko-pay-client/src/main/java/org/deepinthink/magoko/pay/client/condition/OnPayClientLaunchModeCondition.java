 ...
 */
package org.deepinthink.magoko.pay.client.condition;
...
class OnPayClientLaunchModeCondition extends SpringBootCondition {
  ...
  public ConditionOutcome getMatchOutcome(
    ...
    Map<String, Object> attributes =
        Objects.requireNonNull(
            metadata.getAnnotationAttributes(ConditionalOnPayClientLaunchMode.class.getName()));
  ...
  private ConditionOutcome getMatchOutcome(
    ...
    ConditionMessage.Builder builder =
        ConditionMessage.forCondition(ConditionalOnPayClientLaunchMode.class);
    try {
